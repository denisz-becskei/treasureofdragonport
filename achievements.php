...
<div class="container_push">
    ...
    <table style="position: relative; left: 20vw;">
        ...
        <?php include "externalPHPfiles/achievement_handler.php"; check_for_achievement_collection();?>
            ...
            <tr style="height: 120px;"><td><img src="assets/full_collection.png" class="pics  <?php if (!get_achievement_status(10)) {echo "grayscale";} ?>" alt="Teljes kollekció(1. szezon)"><p class="title">Teljes kollekció(1. szezon)</p><p class="desc" style="margin-bottom: -15px;">Szerezd meg a teljes kollekciót!</p></td><td><img src="https://preview.redd.it/4rdhhqf76qq51.jpg?width=400&format=pjpg&auto=webp&s=1d97fc31e921728ffaf86b32e34b9a32aa90bdb5" class="pics2 <?php if (!get_achievement_status(11)) {echo "grayscale";} ?>" alt="LEGENDÁS!"><p class="title">LEGENDÁS!</p><p class="desc" style="margin-bottom: -15px;">Szerezz meg 1 Legendás érmét!</p></td><td><img src="https://static.wikia.nocookie.net/paladins_gamepedia/images/8/8e/Card_Spitfire.png" class="pics <?php if (!get_achievement_status(12)) {check_for_achievement(12); if (!get_achievement_status(12)) {echo "grayscale";}} ?>" alt="Bumm-bumm!"><p class="title">Bumm-bumm!</p><p class="desc" style="margin-bottom: -15px;">Szerezd meg az összes Blaster érmét!</p></td></tr>
