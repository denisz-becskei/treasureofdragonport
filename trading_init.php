...
<div class="container_push">
    <?php include "externalPHPfiles/trading_functionality.php"; ?>
    <div style="position:relative; left: 400px; top: 175px; width: 720px; height: 512px; background-image: url('assets/trading-bg.png'); color: white">
        ...
        <form style="position:relative; left: 0; top: 130px; text-align: center;" action="trading_init.php" method="POST">
            <p style="font-size: 26px;"><?php $code = insert_code(); echo $code;?></p>
            <p>Add át a kódot a csere másik tagjának!</p>
            <input style="background-color: transparent; padding: 10px calc(455px / 3) 10px calc(455px / 3); border: 1px solid darkgray; color: white" type="submit" name="code_has_been_given" value="A kódot átadtam">
        </form>
    </div>
</div>

<?php
if (isset($_POST["code_has_been_given"])) {
    setcookie("trade-initiated", true);
    setcookie("trader", true);
    setcookie("trade-code", $code);
